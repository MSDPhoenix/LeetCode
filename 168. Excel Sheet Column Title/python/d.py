def convertToTitle(columnNumber):
    ...
    while columnNumber > 0:
        ...
        # print("alpha[columnNumber]",alpha[columnNumber%26])
        # # print("",)
        # # print("",)
        # # print("",)
        # # print("",)
...
print("1 --> ",convertToTitle(1)) # A
    # column number 1 -> 0 , title = alpha[0]..., 0//26 = 0
print("2 --> ",convertToTitle(2))
    # column number 2 -> 1 , title = alpha[1]..., 1//26 = 0
...
print("26 --> ",convertToTitle(26)) # Z
    # column number 26 -> 25 , title = alpha[25]..., 25//26 = 0
print("\n*")
print("27 --> ",convertToTitle(27))# AA
    # column number 27 -> 26 , title = alpha[0]..., 26//26 = 1
    # column number 1 -> 0 , title = alpha[0]..., 0//26 = 0
print("28 --> ",convertToTitle(28))
    # column number 28 -> 27 , title = alpha[1]..., 27//26 = 1
    # column number 1 -> 0 , title = alpha[0]..., 0//26 = 0
print("51 --> ",convertToTitle(51))
print("52 --> ",convertToTitle(52)) # AZ
    # column number 52 -> 51 , title = alpha[25]..., 51//26 = 1
    # column number 1 -> 0 , title = alpha[0]..., 0//26 = 0
print("\n*")
print("53 --> ",convertToTitle(53)) # BA
    # column number 53 -> 52 , title = alpha[0]..., 52//26 = 2
    # column number 2 -> 1 , title = alpha[1]..., 2//26 = 0
...
print("703 --> ",convertToTitle(703)) # AAA
    # column number 703 -> 702 , title = alpha[0]..., 702//26 = 27
    # column number 27 -> 26 , title = alpha[0]..., 26//26 = 1
    # column number 1 -> 0 , title = alpha[0]..., 0//26 = 0
